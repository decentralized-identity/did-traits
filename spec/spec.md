...
| Trait                                                                                                                                 | Definition                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <a id="supportsUpdate" href="#comp-supportsUpdate">Update supported</a>                                                               | DID Documents can be updated, see https://w3c.github.io/did-core/#method-operations.                                                                                                                                                                                                                                                                                                                                                               |
| <a id="supportsUpdateServiceEndpoints" href="#comp-supportsUpdateServiceEndpoints">Service Endpoints can be updated</a>               | Service Endpoints can be updated, see https://w3c.github.io/did-core/#services.                                                                                                                                                                                                                                                                                                                                                                    |
| <a id="supportsDeactivate" href="#comp-supportsDeactivate">Deactivate supported</a>                                                   | DIDs can be deactivated, see https://w3c.github.io/did-core/#method-operations.                                                                                                                                                                                                                                                                                                                                                                    |
| <a id="supportsDelete" href="#comp-supportsDelete">Delete supported</a>                                                               | DID method's capability to permanently remove a DID and its associated DID document from the underlying system, rendering the identifier and its history unresolvable.                                                                                                                                                                                                                                                                             |
...
| <a id="supportsUpdateVerificationMethods" href="#comp-supportsUpdateVerificationMethods">Verification Methods can be updated</a>      | Verification methods can be updated, allowing cryptographic keys to be replaced or updated, see https://w3c.github.io/did-core/#verification-methods.                                                                                                                                                                                                                                                                                              |
